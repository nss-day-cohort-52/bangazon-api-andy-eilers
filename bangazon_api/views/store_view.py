...
class StoreView(ViewSet):
    ...
    def favorite(self, request, pk):
        try:
            ...
            favorite.save()
            return Response({'message': "This is one of your favorite stores"}, status=status.HTTP_201_CREATED)
        except (Store.DoesNotExist) as ex:
            return Response({'message': ex.args[0]}, status=status.HTTP_404_NOT_FOUND)
    ...
    def unfavorite(self, request, pk):
        try:
            ...
            favorite.delete()
            return Response({'message': "You no longer consider this store a favorite"},
